...
public class BatchJunit4ClassRunner extends BatchParentRunner<FrameworkMethod> {
     ...
     */
    public BatchJunit4ClassRunner(Class<?> testClass) throws InitializationError {
        super(testClass);
    }
     ...
     * @since 4.13
     */
    protected BatchJunit4ClassRunner(TestClass testClass) throws InitializationError {
        super(testClass);
    }
    ...
    protected List<MethodRule> rules(Object target) {
        BatchJunit4ClassRunner.RuleCollector<MethodRule> collector = new BatchJunit4ClassRunner.RuleCollector<MethodRule>();
    ...
    protected List<TestRule> getTestRules(Object target) {
        BatchJunit4ClassRunner.RuleCollector<TestRule> collector = new BatchJunit4ClassRunner.RuleCollector<TestRule>();
